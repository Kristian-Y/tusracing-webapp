        ...
        <div className="hero-content text-center text-neutral-content relative z-10">
          <div className="max-w-4xl">
            <AnimatedSection delay={0} direction="up">
              <div className="mb-6">
                <span className="inline-block px-4 py-2 bg-red-600 text-white text-sm font-bold rounded-full uppercase tracking-wider animate-pulse">
                  Since 2015
                </span>
              </div>
            </AnimatedSection>
            <AnimatedSection delay={200} direction="up">
              <h1 className="text-6xl md:text-8xl font-black mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-red-500">
                TU Sofia
                <br />
                <span className="text-red-500">Racing Team</span>
              </h1>
            </AnimatedSection>
            ...
            <AnimatedSection delay={600} direction="up">
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button className="btn btn-red btn-lg px-8 shadow-2xl hover:scale-105 transition-transform duration-300">
                  Our Cars
                </button>
                <button className="btn btn-outline btn-lg px-8 border-white text-white hover:bg-white hover:text-black transition-all duration-300">
                  Join Team
                </button>
              </div>
            </AnimatedSection>
              ...
              <div className="group relative bg-gradient-to-br from-base-200 to-base-300 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-baseline gap-2">
                    <span className="text-3xl font-black text-red-500">{achievement.value}</span>
              ...
              <AnimatedSection key={value.title} delay={index * 150}>
                <div className="text-center group">
                  <div className="relative inline-flex items-center justify-center w-24 h-24 mb-6">
                    ...
                    <div className="relative bg-gradient-to-br from-red-500 to-red-600 rounded-full w-20 h-20 flex items-center justify-center text-white text-4xl shadow-lg group-hover:rotate-12 transition-transform duration-300">
                      {value.icon}
                    </div>
                  </div>
              ...
              <div className="bg-base-200 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 group">
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0">
                    <div className="w-16 h-16 rounded-full overflow-hidden ring-4 ring-red-500/20 group-hover:ring-red-500/40 transition-all duration-300">
        ...
        <div className="container mx-auto px-6 py-24 text-center relative z-10">
          ...
          <AnimatedSection delay={400}>
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <a
                href="/contact"
                className="btn btn-white btn-lg px-10 text-red-600 font-bold hover:scale-105 transition-all duration-300 shadow-2xl"
              >
                Become a Sponsor
              </a>
              <a
                href="/join"
                className="btn btn-outline btn-lg px-10 border-white text-white hover:bg-white hover:text-red-600 font-bold transition-all duration-300"
              >
                Join Our Team
              </a>
            </div>
